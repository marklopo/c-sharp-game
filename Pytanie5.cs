		...
		public static void  pytanie_5()
		{
			...
			if (decyzja.Equals("a") || decyzja.Equals("A")) {
				...
				if (pytanie1 == poprawnaodpowiedz) {
					Pytania.pytanie_5_Wygrana();
					Console.WriteLine("\n---------------------------------------------------------------------");
                    Console.ReadKey();
                    Console.Clear();
                    Menu.menu1();
                } else {
					Pytania.pytanie_5_ZlaOdpowiedz();
					Console.ReadKey();
					Console.Clear();
					Podpowiedz.pod_4();
					Menu.menu1();
				...
				if (podpowiedz1 == 1) {
					...
					if (decyzja1.Equals("a") || decyzja1.Equals("A")) {
						...
						if (podpowiedz1 == 2) {
							...
							Console.WriteLine("+-------------------------------------+");
							Pytania.pytanie_5_5050_TelDoPrzyjaciela();
							Console.Write("\nJaka jest Twoja odpowiedź? ");
							int pytanie1 = Convert.ToInt32(Console.ReadLine());
							if (pytanie1 == poprawnaodpowiedz) {
								Pytania.pytanie_5_Wygrana();
						...
						if (podpowiedz1 == 3) {
							...
							Console.WriteLine("+--------------------------------------+");
							Pytania.pytanie_5_5050_pytDoPubl();
							Console.Write("\nJaka jest Twoja odpowiedź? ");
							int pytanie1 = Convert.ToInt32(Console.ReadLine());
							if (pytanie1 == poprawnaodpowiedz) {
								Pytania.pytanie_5_Wygrana();
						...
						Pytania.pytanie_5_Wygrana_Koniec();
						Console.ReadKey();
						Podpowiedz.pod_4();
						Console.Clear();
						Menu.menu1();
					...
					Console.WriteLine("+--------------------------------------+");
					Pytania.pytanie_5_TelDoPrzyjaciela();
					if(Podpowiedz.liczba().Equals(0)){
						Console.Write("\nJaka jest Twoja decyzja: A. Odpowiedź C. Koniec gry? ");
					}
					else {
					...
					if (decyzja1.Equals("a") || decyzja1.Equals("A")) {
						...
						if (podpowiedz1 == 1) {
							...
							Console.WriteLine("KOŁO RATUNKOWE: 50 / 50");
							Console.WriteLine("+--------------------------------------+");
							Pytania.pytanie_5_TelDoPrzyjaciela_5050();
							Console.Write("\nJaka jest Twoja odpowiedź? ");
							int pytanie1 = Convert.ToInt32(Console.ReadLine());
							if (pytanie1 == poprawnaodpowiedz) {
								Pytania.pytanie_5_Wygrana();
						...
						if (podpowiedz1 == 3) {
							...
							Console.WriteLine("KOŁO RATUNKOWE: Pytanie do publiczności");
							Console.WriteLine("+--------------------------------------+");
							Pytania.pytanie_5_TelDoPrzyjaciela_pytDoPubl();
							Console.Write("\nJaka jest Twoja odpowiedź? ");
							int pytanie1 = Convert.ToInt32(Console.ReadLine());
							if (pytanie1 == poprawnaodpowiedz) {
								Pytania.pytanie_5_Wygrana();
					...
					if (decyzja1.Equals("a") || decyzja1.Equals("A")) {
						...
						if (podpowiedz1 == 1) {
							...
							Console.WriteLine("KOŁO RATUNKOWE: 50 / 50");
							Console.WriteLine("+--------------------------------------+");
							Pytania.pytanie_5_pytDoPubl_5050();
							Console.Write("\nJaka jest Twoja odpowiedź? ");
							int pytanie1 = Convert.ToInt32(Console.ReadLine());
							if (pytanie1 == poprawnaodpowiedz) {
								Pytania.pytanie_5_Wygrana();
						...
						if (podpowiedz1 == 2) {
							...
							Console.WriteLine("KOŁO RATUNKOWE: Telefon do przyjaciela");
							Console.WriteLine("+--------------------------------------+");
							Pytania.pytanie_5_pytDoPubl_TelDoPrzyjaciela();
							Console.Write("\nJaka jest Twoja odpowiedź? ");
							int pytanie1 = Convert.ToInt32(Console.ReadLine());
							if (pytanie1 == poprawnaodpowiedz) {
								Pytania.pytanie_5_Wygrana();
